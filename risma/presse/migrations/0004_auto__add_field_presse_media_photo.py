...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Presse.media_photo'
        db.add_column('presse_presse', 'media_photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Presse.media_photo'
        db.delete_column('presse_presse', 'media_photo')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CommuniquePresse.fichier_ar'
        db.add_column('presse_communiquepresse', 'fichier_ar', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CommuniquePresse.fichier_ar'
        db.delete_column('presse_communiquepresse', 'fichier_ar')
